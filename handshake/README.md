# Features
Arduino sends a "handshake" signal to Raspberry Pi so it knows if the pneumatics system is operating within a decent range. Sets the signal HIGH if the pressure is OK; LOW otherwise.
